...
public class DeleteCustomer extends JFrame implements ActionListener{
    ...
    DeleteCustomer(String username){
        ...
        btnDelete.setBounds(270, 350, 140, 30);
        btnDelete.setFont(new Font("Tahoma", Font.PLAIN, 16));
        btnDelete.addActionListener(this);
        add(btnDelete);
        
        btnBack = new JButton("Back");
        btnBack.setBounds(420, 350, 140, 30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == btnDelete){
            try {
            DbConnection d = new DbConnection();
            d.s.executeUpdate("delete from account where username = '"+username1+"'");
            d.s.executeUpdate("delete from customer where username = '"+username1+"'");
            d.s.executeUpdate("delete from bookPackage where username = '"+username1+"'");
            d.s.executeUpdate("delete from bookHotel where username = '"+username1+"'");
