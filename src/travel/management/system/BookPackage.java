	...
	public BookPackage(String username) {
		...
		contentPane.add(l5);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from customer where username = '"+username1+"'");
                    while(rs.next()){
                        l1.setText(rs.getString("username"));
                        l2.setText(rs.getString("id"));
                        l3.setText(rs.getString("number"));
                        l4.setText(rs.getString("phoneNo"));
		...
		btnNewButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                            ...
                            String username2 = l1.getText();
                            String selectedItem = c1.getSelectedItem();
                            String persons = t1.getText();
                            String id = l2.getText();
                            String number = l3.getText();
                            String phoneNo = l4.getText();
                            String price = l5.getText();
                        
                        try{
                            
                            DbConnection c = new DbConnection();
                            String q1 = "insert into bookPackage values('"+username2+"', '"+selectedItem+"', '"+persons+"', '"+id+"', '"+number+"', '"+phoneNo+"', '"+price+"')";
